...
unthinking renormalization that tends to occur almost everywhere in machine learning (including, of course, the very architecture of artificial neurons).\footnote{For a constructive alternative in the portfolio setting see the \texttt{allocation} package \citep{allocationpkg}.}    
...
its fast inverse transform come from racing \citep{cotton2021}, ship in
the \texttt{winning} package \citep{winningpkg}, and the common-factor
extension developed here is named there as an open problem.
