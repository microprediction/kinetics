...
experiments 13--27, 29--31, and 33--38; 28 supports the companion
paper alone, 27 is shared with it, and 32 is exploratory work not used
here).
A single manifest,
\texttt{experiments/run\_all\_paper.py}, regenerates every table and
figure; this submission is built from the tag
\texttt{jcgs-v1} (commit \texttt{3ace74cf}). (Archive supplied as a zip with
