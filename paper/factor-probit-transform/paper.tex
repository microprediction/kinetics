...
(\url{https://github.com/microprediction/kinetics}, experiments 13--20; the
...
algorithm that calibrates factor-structured probit at a thousand
alternatives in under a minute. Its cost grows linearly from there, reaching
ten thousand alternatives in eleven minutes, where calibration through the
standard simulator at matched accuracy extrapolates to weeks. Conditionally on the factors the
...
shift. Forward errors stay below one part in a thousand from five to five
thousand alternatives, and the experiments locate where the required factor
approximation of the covariance fails.
\end{abstract}
...
lattice is effectively spectrally accurate and the $L$-error is
subdominant. Holding $L$
