...
minute. Cost grows roughly linearly: ten thousand alternatives take minutes.
The standard simulation route, extrapolated from our own implementation,
would take weeks at the same accuracy. Conditionally on the factors the
