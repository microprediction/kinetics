...
\paragraph{Log-odds accuracy.} Against super-converged references
...
$10^{-9}$). No simulation reference could certify any of this: pinning
relative error $\epsilon$ on a share $p$ takes about $1/(p\epsilon^2)$
draws.
