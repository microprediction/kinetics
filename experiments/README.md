...
| **Exp 4** — temperature transfer on a Kramers barrier-crossing simulation | [`exp04_kramers_transfer/`](exp04_kramers_transfer) | Arrhenius rescaling halves transfer error at kT 1.0→0.7 and →0.55; noise law (Gumbel vs Gaussian) second-order; residual is correlational |
