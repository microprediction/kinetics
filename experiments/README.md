...
| **Exp 14** — **boundary studies** for the algorithm paper | [`exp14_boundaries/`](exp14_boundaries) | expected GHK-wins regime did not materialize (k=8 ≥ GHK R=10⁴ at all spectral decays); substitution: probit misallocates 7% of redistributed mass vs 15% (mixed logit) vs 21% (IIA) |
